...
- [x] What is the purpose of using _sessions_?
        ...
        a way to store information across pages

- [x] What does bcrypt do to help us store passwords in a secure manner.

        encrypts the passwords in your database

- [x] What does bcrypt do to slow down attackers?

        an iteration count can be set to make passwords resistant to brute-force search attacks
